    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li>
            ...
            <div>
              <input class="inp_1" name="main_hy" id="main_hy" value="<?php echo ($shangchang["main_hy"]); ?>"/>
            </div>
         </li>
          <li>
            <div style="color:#c00; font-size:14px; padding-left:20px;">logo大小：100px * 100px 店铺广告图:  480px * 200px</div>
         </li>
         <li>
            <div class="d1">企业LOGO:</div>
            <div>
              <?php if ($shangchang['logo']) { ?>
                  <img src="/minibuxiugangjyw/Data/<?php echo $shangchang['logo']; ?>" width="80" height="80" style="margin-bottom: 3px;" /><br />
              <?php } ?>
         ...
         <li>
            ...
            <div>
              <?php if ($shangchang['vip_char']) { ?>
                  <img src="/minibuxiugangjyw/Data/<?php echo $shangchang['vip_char']; ?>" width="240" height="100" style="margin-bottom: 3px;" /><br />
              <?php } ?>
              <input type="file" name="vip_char" id="vip_char" style="width:160px;" />
            </div>
         </li>
         <li>
            <div class="d1">企业介绍:</div>
            <div>
